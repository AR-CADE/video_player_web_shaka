...
import 'package:video_player_web_shaka/src/video_player.dart';

/// The web implementation of [VideoPlayerPlatform].
///
/// This class implements the `package:video_player` functionality for the web.
class VideoPlayerPluginShaka extends VideoPlayerPlatform {
  /// Registers this class as the default instance of [VideoPlayerPlatform].
  static void registerWith(Registrar registrar) {
    Shaka.polyfill.installAll();
    VideoPlayerPlatform.instance = VideoPlayerPluginShaka();
  }
