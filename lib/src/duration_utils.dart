...
/// Converts a `num` duration coming from a `VideoElement` into a
/// [Duration] that the plugin can use.
///
/// From the documentation, `videoDuration` is a double-precision
/// floating-point value indicating the duration of the media in seconds.
